@php
    ...
    $initialIconKey = $initialIconKey ?? 'PDF_initial';
    $transformedIconKey = $transformedIconKey ?? 'PDF_check_transformed';
...
<div class="icon-container" id="iconContainerPDF">
